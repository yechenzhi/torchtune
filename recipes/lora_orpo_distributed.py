...
class LoRAORPORecipeDistributed(FTRecipeInterface):
    """
    ...
    def train(self) -> None:
        ...
        for curr_epoch in range(self.epochs_run, self.total_epochs):
            ...
            for idx, batch in enumerate(
                ...
                orpo_loss, chosen_rewards, rejected_rewards,log_odds_ratio, log_odds_chosen = self._loss_fn(
                    policy_chosen_log_probs,
                    policy_rejected_log_probs
                )
...
def recipe_main(cfg: DictConfig) -> None:
    ...
    recipe = LoRAORPORecipeDistributed(cfg=cfg)
